...
import com.kide.terminal.TerminalColors;
import com.kide.terminal.TerminalSession;
import com.kide.terminal.TerminalSession.SessionChangedCallback;
import com.kide.terminal.TextStyle;
import com.kide.view.TerminalView;
...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    public static final String TERMUX_FAILSAFE_SESSION_ACTION = "com.kide.app.failsafe_session";
    ...
    private static final String RELOAD_STYLE_ACTION = "com.kide.app.reload_style";

    private static final String BROADCAST_TERMUX_OPENED = "com.kide.app.OPENED";
    ...
    void checkForFontAndColors() {
        try {
            @SuppressLint("SdCardPath") File fontFile = new File("/data/data/com.kide/files/home/.kide/font.ttf");
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/com.kide/files/home/.kide/colors.properties");
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case CONTEXTMENU_STYLING_ID: {
                ...
                stylingIntent.setClassName("com.kide.styling", "com.kide.styling.TermuxStyleActivity");
                try {
