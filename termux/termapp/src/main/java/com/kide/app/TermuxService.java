...
import com.kide.R;
import com.kide.terminal.EmulatorDebug;
import com.kide.terminal.TerminalSession;
import com.kide.terminal.TerminalSession.SessionChangedCallback;
...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public static final String FILES_PATH = "/data/data/cn.minxyzgo.kide/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final int NOTIFICATION_ID = 1337;

    private static final String ACTION_STOP_SERVICE = "com.kide.service_stop";
    private static final String ACTION_LOCK_WAKE = "com.kide.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "com.kide.service_wake_unlock";
    /** Intent action to launch a new terminal session. Executed from TermuxWidgetProvider. */
    public static final String ACTION_EXECUTE = "com.kide.service_execute";

    public static final String EXTRA_ARGUMENTS = "com.kide.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "com.kide.execute.cwd";
    public static final String EXTRA_EXECUTE_IN_BACKGROUND = "com.kide.execute.background";
    ...
    TerminalSession createTermSession(String executablePath, String[] arguments, String cwd, boolean failSafe) {
        ...
        Intent stylingIntent = new Intent("com.kide.app.reload_style");
        stylingIntent.putExtra("com.kide.app.reload_style", "styling");
