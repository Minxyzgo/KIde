...
public class TermuxOpenReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (data == null) {
            Log.e(EmulatorDebug.LOG_TAG, "kide-open: Called without intent data");
            return;
        }
        ...
        if (isExternalUrl) {
            ...
            try {
                ...
                Log.e(EmulatorDebug.LOG_TAG, "kide-open: No app handles the url " + data);
            }
            return;
        }
        ...
        if (!(fileToShare.isFile() && fileToShare.canRead())) {
            Log.e(EmulatorDebug.LOG_TAG, "kide-open: Not a readable file: '" + fileToShare.getAbsolutePath() + "'");
            return;
        }
        ...
        Uri uriToShare = Uri.parse("content://com.kide.files" + fileToShare.getAbsolutePath());
